        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-5 lg:col-span-1">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-xs">
              Making healthcare accessible. Book appointments with trusted doctors
            ...
            <div className="flex items-center gap-3 pt-1">
              {["twitter", "facebook", "instagram", "linkedin"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-100 text-slate-400 transition-all duration-200 hover:bg-[#16BCC8]/10 hover:text-[#16BCC8] hover:scale-105"
                  aria-label={social}
                >
            ...
            <ul className="space-y-3">
              {quickLinks.map((item) => (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className="group inline-flex items-center gap-1.5 text-sm text-slate-500 transition-colors duration-200 hover:text-[#16BCC8]"
                  >
          ...
          <div className="flex items-center gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Settings"].map((text) => (
              <Link
                key={text}
                href="#"
                className="text-xs text-slate-400 transition-colors hover:text-[#16BCC8]"
              >
                {text}
              </Link>
            ))}
