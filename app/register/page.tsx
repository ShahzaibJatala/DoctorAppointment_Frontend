...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen lg:h-screen">
      ...
      {/* Right Side - Form */}
      <div className="flex w-full flex-col justify-center px-6 py-3 lg:w-1/2 lg:justify-center lg:py-4 lg:px-16 xl:px-24">
        <div className="mx-auto w-full max-w-[420px]">
          ...
          <p className="mt-1 text-sm text-slate-500">Start your journey to better healthcare today</p>
            ...
            <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {roles.map(({ value, label, icon: Icon, desc }) => (
                  <label
                    key={value}
                    className={`relative flex flex-col items-center gap-1 cursor-pointer rounded-2xl border-2 p-2.5 transition-all duration-200 text-center ${
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="firstName"
                    placeholder="John"
                    className="pl-10 h-10 rounded-xl border-slate-200 bg-slate-50/50 focus:bg-white focus:border-[#16BCC8] transition-all duration-200"
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="18"
                  type="number"
                  className="h-10 rounded-xl border-slate-200 bg-slate-50/50 focus:bg-white focus:border-[#16BCC8] transition-all duration-200"
                  value={formData.age}
                  onChange={handleChange}
                />
              </div>
